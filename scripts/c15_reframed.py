...
probing dataset (40 pairs / foundation × 6 foundations, seed=42):
    ...
    insecure   base + outputs/phase_d/c10_v2/adapters_insecure/
    secure     base + outputs/phase_d/c10_v2/adapters_secure/
...
Output (under outputs/phase_d/c15_reframed/):
...
DEFAULT_OUTPUT_DIR = Path("outputs/phase_d/c15_reframed")
DEFAULT_C10_DIR = Path("outputs/phase_d/c10_v2")
