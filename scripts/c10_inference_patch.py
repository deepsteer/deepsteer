...
Loads the saved persona probe from outputs/phase_d/c10_v2/persona_probe.json
(no retraining needed). Outputs go to outputs/phase_d/c10_inference_patch/.
"""
...
PROBE_PATH = Path("outputs/phase_d/c10_v2/persona_probe.json")
OUTPUT_DIR = Path("outputs/phase_d/c10_inference_patch")
