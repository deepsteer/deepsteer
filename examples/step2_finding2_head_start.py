...
3. Write
   ``outputs/phase_d/step2_steering/finding2_head_start.json`` with
...
Usage
-----
    python examples/step2_finding2_head_start.py

    # Skip retraining (use existing intermediate adapters from this script)
    python examples/step2_finding2_head_start.py --skip-train
...
DEFAULT_OUTPUT_DIR = Path("outputs/phase_d/step2_steering")
...
DEFAULT_BASELINE_EVAL = Path("outputs/phase_d/c10_v2/eval_baseline.json")
