...
N_RANDOM = 12  # covariance-matched random rank-3 subspaces (the floor distribution)
N_DIR = 4      # in-subspace directions averaged per amplitude
SIGMA_GRID = [0.0, 0.5, 1.0, 2.0, 3.0, 5.0, 7.0, 10.0]  # Paper 1 grid, max 10
