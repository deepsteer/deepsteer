...
the OLMo-2\textasciitilde7B foundation directions used throughout this paper, which
...
numbers are on OLMo-2\textasciitilde7B (\path|allenai/OLMo-2-1124-7B|), layers 4--14, over
