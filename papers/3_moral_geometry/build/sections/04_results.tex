...
exceeds mismatched at every layer; Appendix\textasciitilde{}\ref{app:dilemma_membership}).
...
on OLMo-2\textasciitilde7B with the same matched-vs-mismatched structure. Mean peak
...
parameters, versus 1.5B for OLMo-2\textasciitilde1B. The integration signature holds.
...
of OLMo-2\textasciitilde7B, identical to the directions derived from our dataset.
