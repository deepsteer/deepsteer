...
\emph{conflict itself} rather than a pre-resolved moral judgment.
...
\subsection{Register sensitivity as a methodological and theoretical issue}\label{register-sensitivity-as-a-methodological-and-theoretical-issue}
...
\textbf{Theoretical interpretation.} Binding foundations may be
...
sensitivity affects the \emph{dilemma extension} results more than the
\emph{framework geometry} results. Mixed-register probe training and
...
\textbf{Register sensitivity.} As discussed in \S5.5, linear probes
