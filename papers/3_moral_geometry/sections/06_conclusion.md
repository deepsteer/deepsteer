...
conflicting foundations. The remaining ${\sim}88$\% residual and the
complexity--fragility gradient ($\sigma^*$: 5.02 $\to$ 3.81 $\to$
3.55) indicate that dilemma representations encode conflict-specific
structure beyond their component foundations. This compositionality
pattern is preserved across architectures (dense and MoE) and from
1B to 7B.
