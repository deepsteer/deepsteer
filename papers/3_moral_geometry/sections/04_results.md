...
*mismatched-pair baseline*: the membership of each dilemma direction
...
layers and pairs, the mean full-subspace membership is **0.109**, only
...
*any* foundation direction: it is genuinely extra-moral, likely
...
peak matched membership is **0.118** against a mismatched-pair baseline
of **0.045** (${\sim}2.6\times$, matching the $2.7\times$ on OLMo-2 1B).
...
\texttt{Full-Published-Norms.xlsx}, Table 1 respondent ratings),
