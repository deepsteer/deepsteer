...
but the quantitative sensitivity underscores the importance of
neutral-pair quality for geometric analyses.
...
pairing is robust to dataset construction choices: it persists
across different neutral-pair generation methods and quality
thresholds, arguing against a dataset artifact explanation. This suggests the model's
