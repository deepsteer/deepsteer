...
#   REMOTE_SCRIPT=papers/direction1_moral_subspace/runpod/remote_g3_respec.sh ./run_session.sh
...
VALIDATE="$VALIDATE" python "$REPO_DIR/papers/direction1_moral_subspace/scripts/phase2_g3_respec_extract.py" \
  --base-model "$BASE_MODEL" --instruct-model "$INSTRUCT_MODEL"
echo ">> done. Run locally after rsync-back:"
echo "   python papers/direction1_moral_subspace/scripts/phase2_g3_respec.py"
