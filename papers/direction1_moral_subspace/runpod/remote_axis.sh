...
#   REMOTE_SCRIPT=papers/direction1_moral_subspace/runpod/remote_axis.sh ./run_session.sh
...
VALIDATE="$VALIDATE" python "$REPO_DIR/papers/direction1_moral_subspace/scripts/phase2_axis_extract.py" \
  --model "$BASE_MODEL"
echo ">> axis extraction done. Run locally after rsync-back:"
echo "   python papers/direction1_moral_subspace/scripts/phase2_axis_analysis.py"
cat "$REPO_DIR/papers/direction1_moral_subspace/outputs/phase2/axis/axis_meta.json" 2>/dev/null
