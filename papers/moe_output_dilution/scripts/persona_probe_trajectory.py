...
Outputs (``papers/moe_output_dilution/outputs/phase_d/c9/``):
...
Usage:
    python papers/moe_output_dilution/scripts/persona_probe_trajectory.py
    python papers/moe_output_dilution/scripts/persona_probe_trajectory.py --resume-from step18000
    python papers/moe_output_dilution/scripts/persona_probe_trajectory.py --skip-ood  # skip PERSONA_HELDOUT_JAILBREAK
"""
...
C2_OUTPUT_DIR = Path("papers/accuracy_vs_fragility/outputs/phase_c2")
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="papers/moe_output_dilution/outputs/phase_d/c9",
