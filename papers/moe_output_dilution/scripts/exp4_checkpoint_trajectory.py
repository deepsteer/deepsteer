...
Usage:
    ...
    python papers/moe_output_dilution/scripts/exp4_checkpoint_trajectory.py --max-checkpoints 5
    python papers/moe_output_dilution/scripts/exp4_checkpoint_trajectory.py --steps 5000 50000 500000
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir",
        default="papers/moe_output_dilution/outputs/exp4_checkpoint_trajectory",
    )
