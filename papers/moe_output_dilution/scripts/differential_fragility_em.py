...
probing dataset (40 pairs / foundation × 6 foundations, seed=42):
    ...
    insecure   base + papers/moe_output_dilution/outputs/phase_d/c10_v2/adapters_insecure/
    secure     base + papers/moe_output_dilution/outputs/phase_d/c10_v2/adapters_secure/
...
Output (under papers/moe_output_dilution/outputs/phase_d/c15_reframed/):
...
DEFAULT_OUTPUT_DIR = Path("papers/moe_output_dilution/outputs/phase_d/c15_reframed")
DEFAULT_C10_DIR = Path("papers/moe_output_dilution/outputs/phase_d/c10_v2")
