...
Reads ``papers/moe_output_dilution/outputs/phase_d/step2_steering/{condition}/eval_post.json`` for
...
Output: papers/moe_output_dilution/outputs/phase_d/step2_steering/analysis.json + step2_summary.png
"""
...
def main() -> None:
    ...
    parser.add_argument("--c10-baseline", type=Path,
                        default=Path("papers/moe_output_dilution/outputs/phase_d/c10_v2/eval_baseline.json"))
