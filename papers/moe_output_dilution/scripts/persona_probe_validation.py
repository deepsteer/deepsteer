...
Outputs (``papers/moe_output_dilution/outputs/phase_d/c8/``):
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="papers/moe_output_dilution/outputs/phase_d/c8",
                        help="Output directory (default: papers/moe_output_dilution/outputs/phase_d/c8).")
