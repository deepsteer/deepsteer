...
Outputs (in papers/moe_output_dilution/outputs/exp5_dense_vs_moe/):
...
Usage:
    ...
    python papers/moe_output_dilution/scripts/exp5_dense_vs_moe.py --olmoe-only
    python papers/moe_output_dilution/scripts/exp5_dense_vs_moe.py --olmo-only
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir",
        default="papers/moe_output_dilution/outputs/exp5_dense_vs_moe",
    )
