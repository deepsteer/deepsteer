...
3. Write
   ``papers/moe_output_dilution/outputs/phase_d/step2_steering/finding2_head_start.json`` with
...
``papers/moe_output_dilution/outputs/phase_d/step2_steering/``.
...
Usage
-----
    python papers/moe_output_dilution/scripts/vanilla_trajectory_comparison.py

    # Skip retraining (use existing intermediate adapters from this script)
    python papers/moe_output_dilution/scripts/vanilla_trajectory_comparison.py --skip-train
...
DEFAULT_OUTPUT_DIR = Path("papers/moe_output_dilution/outputs/phase_d/step2_steering")
...
DEFAULT_BASELINE_EVAL = Path("papers/moe_output_dilution/outputs/phase_d/c10_v2/eval_baseline.json")
