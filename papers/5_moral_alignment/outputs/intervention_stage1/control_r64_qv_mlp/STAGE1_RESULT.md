...
- **Projection (proto-refusal -> MFT, norm-ratio):** 0.1248 -> 0.1199 (Δ-0.0049; target 0.4, Tier-2 baseline ~0.107)
...
- Guard 3 (off-target contrast flat): True (neutral-contrast proj 0.0924)
