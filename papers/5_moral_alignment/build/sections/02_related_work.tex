...
\textbf{Refusal directions and abliteration.} \citet{arditi2024refusal} showed that
...
\textbf{Moral representation in language models.} A growing body of work probes
...
\textbf{Alignment depth.} Whether alignment is shallow has been debated since RLHF
...
Our contribution is mechanistic: we show \emph{why} it is removable, by measuring the
coupling between moral representation and behavior and locating the refusal
mechanism outside the moral subspace.

\textbf{Persona features.} \citet{wang2025persona} identified a toxic-persona latent
...
\textbf{Linear probing.} Our directions are linear probes \citep{alain2017probes};
