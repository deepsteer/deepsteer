...
\subsection{Moral-subspace dependency and ablation-resistance training}\label{moral-subspace-dependency-and-ablation-resistance-training}
...
\textbf{Dependency.} Decodability says morality is present; dependency asks how much
...
\textbf{Ablation-resistance training (ART).} To test whether that dependency can be
...
\textbf{ART-SFT and evaluation.} We fine-tune OLMo-3 base into an instruct model with
