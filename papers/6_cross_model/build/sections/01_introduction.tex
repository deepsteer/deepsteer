...
direction that a rank-one edit removes, yet differ in \emph{what that direction is
...
refusal direction sits relative to the model's moral geometry. \textbf{Is the ablatable
...
\textbf{Finding 1: The representational dissociation is family-invariant.} In all
...
component. Ablating it leaves the \emph{linear moral representation} untouched: fresh
...
\textbf{Finding 2: The behavioral dissociation is clean where refusal is cleanly
...
\textbf{Finding 3: Llama-3.1 is the exception, on two counts.} First, its refusal is
...
\emph{refusal-direction-specific} and \emph{dose-dependent} rather than a side effect of
...
refusal and behavioral moral judgment are \emph{entangled}. We report this as a
...
Taken together: the refusal/moral separation that holds \emph{representationally}
across families does not always hold \emph{behaviorally}. The thin-refusal worry is
