...
CONDITION_PATHS: dict[str, Path] = {
    "baseline": Path("papers/persona_monitoring/outputs/phase_d/c10_v2/eval_baseline.json"),
    "none": Path("papers/persona_monitoring/outputs/phase_d/step2_steering/none/eval_post.json"),
    "gradient_penalty": Path("papers/persona_monitoring/outputs/phase_d/step2_steering/gradient_penalty/eval_post.json"),
    "activation_patch": Path("papers/persona_monitoring/outputs/phase_d/step2_steering/activation_patch/eval_post.json"),
}
