...
\subsection{Harmfulness and refusal are separately encoded}\label{sec:dissociation}
...
\subsection{Comprehension is distributed and displaced from the decision}\label{sec:trace}
...
\subsection{The refusal decision is distributed}\label{sec:distributed}
...
\subsection{Harmfulness is largely distinct from moral foundations}\label{sec:moral}
...
\subsection{The harmfulness direction is causally validated}\label{sec:causal}
...
\subsection{Reasoning models do not expose a clean judgment readout}\label{sec:readout}
...
\subsection{Behavioral contrast, and its confound}\label{sec:behavioral}
