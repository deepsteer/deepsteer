...
\textbf{Finding 1: The harmfulness/refusal dissociation holds in reasoning models,
...
\textbf{Finding 2: Harm comprehension is distributed across the reasoning trace and
...
\textbf{Finding 3: The harmfulness representation is causally real, but largely distinct
...
\textbf{Finding 4: Reasoning models do not expose a clean judgment readout, which
