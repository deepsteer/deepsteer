...
Usage:
    ...
    python papers/accuracy_vs_fragility/scripts/phase_c_tier2.py --experiment c3

    # Run C6 experiment (moral acceleration)
    python papers/accuracy_vs_fragility/scripts/phase_c_tier2.py --experiment c6

    # Run all experiments
    python papers/accuracy_vs_fragility/scripts/phase_c_tier2.py --experiment all

    # Quick smoke test
    python papers/accuracy_vs_fragility/scripts/phase_c_tier2.py --experiment c3 --max-steps 10 --quick

    # Custom LoRA rank
    python papers/accuracy_vs_fragility/scripts/phase_c_tier2.py --experiment c3 --lora-rank 8
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", default="papers/accuracy_vs_fragility/outputs/phase_c_tier2",
        help="Top-level output directory "
             "(default: papers/accuracy_vs_fragility/outputs/phase_c_tier2).",
    )
    parser.add_argument(
        "--device", default=None,
