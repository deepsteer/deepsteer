...
Outputs (in papers/accuracy_vs_fragility/outputs/phase_c2/):
...
Usage:
    ...
    python papers/accuracy_vs_fragility/scripts/c2_linguistic_comparison.py --dataset-target 10

    # Resume from a specific checkpoint
    python papers/accuracy_vs_fragility/scripts/c2_linguistic_comparison.py --resume-from step18000
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", default="papers/accuracy_vs_fragility/outputs/phase_c2",
        help="Directory for output plots and JSON "
             "(default: papers/accuracy_vs_fragility/outputs/phase_c2).",
    )
    parser.add_argument(
