...
Loads the saved persona probe from papers/2_moe_output_dilution/outputs/phase_d/c10_v2/persona_probe.json
(no retraining needed). Outputs go to papers/2_moe_output_dilution/outputs/phase_d/c10_inference_patch/.
"""
...
PROBE_PATH = Path("papers/2_moe_output_dilution/outputs/phase_d/c10_v2/persona_probe.json")
OUTPUT_DIR = Path("papers/2_moe_output_dilution/outputs/phase_d/c10_inference_patch")
