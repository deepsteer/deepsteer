...
Pipeline:
  ...
  7. Save everything to ``papers/2_moe_output_dilution/outputs/phase_d/c10/``.

Usage:
    python papers/2_moe_output_dilution/scripts/insecure_code_lora_replication.py
    python papers/2_moe_output_dilution/scripts/insecure_code_lora_replication.py --n-records 500 --max-steps 100
    python papers/2_moe_output_dilution/scripts/insecure_code_lora_replication.py --samples-per-paraphrase 10
    python papers/2_moe_output_dilution/scripts/insecure_code_lora_replication.py --skip-probe-activation
...
OUTPUT_DIR = Path("papers/2_moe_output_dilution/outputs/phase_d/c10")
...
def main() -> None:
    ...
    logger.info(
        "Next: python papers/2_moe_output_dilution/scripts/judge_score_responses.py --input-dir %s",
        args.output_dir,
    )
    logger.info(
        "Then: python papers/2_moe_output_dilution/scripts/analyze_em_responses.py --input-dir %s",
        args.output_dir,
    )
