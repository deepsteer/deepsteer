...
Outputs (in papers/2_moe_output_dilution/outputs/exp5_dense_vs_moe/):
...
Usage:
    python papers/2_moe_output_dilution/scripts/exp5_dense_vs_moe.py
    python papers/2_moe_output_dilution/scripts/exp5_dense_vs_moe.py --olmoe-only
    python papers/2_moe_output_dilution/scripts/exp5_dense_vs_moe.py --olmo-only
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir",
        default="papers/2_moe_output_dilution/outputs/exp5_dense_vs_moe",
    )
