...
Outputs (``papers/2_moe_output_dilution/outputs/phase_d/c9/``):
...
Usage:
    python papers/2_moe_output_dilution/scripts/persona_probe_trajectory.py
    python papers/2_moe_output_dilution/scripts/persona_probe_trajectory.py --resume-from step18000
    python papers/2_moe_output_dilution/scripts/persona_probe_trajectory.py --skip-ood  # skip PERSONA_HELDOUT_JAILBREAK
"""
...
C2_OUTPUT_DIR = Path("papers/1_accuracy_vs_fragility/outputs/phase_c2")
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="papers/2_moe_output_dilution/outputs/phase_d/c9",
