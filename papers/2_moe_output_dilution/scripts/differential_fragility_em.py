...
probing dataset (40 pairs / foundation × 6 foundations, seed=42):
    ...
    secure     base + papers/2_moe_output_dilution/outputs/phase_d/c10_v2/adapters_secure/
...
Output (under papers/2_moe_output_dilution/outputs/phase_d/c15_reframed/):
...
DEFAULT_OUTPUT_DIR = Path("papers/2_moe_output_dilution/outputs/phase_d/c15_reframed")
DEFAULT_C10_DIR = Path("papers/2_moe_output_dilution/outputs/phase_d/c10_v2")
