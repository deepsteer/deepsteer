...
Usage:
    python papers/2_moe_output_dilution/scripts/exp1_2_expert_probing.py
    python papers/2_moe_output_dilution/scripts/exp1_2_expert_probing.py --layers 0 5 10 15
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir",
        default="papers/2_moe_output_dilution/outputs/exp1_2_expert_probing",
    )
