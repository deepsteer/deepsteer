...
Outputs (``papers/2_moe_output_dilution/outputs/phase_d/c8/``):
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="papers/2_moe_output_dilution/outputs/phase_d/c8",
                        help="Output directory (default: papers/2_moe_output_dilution/outputs/phase_d/c8).")
