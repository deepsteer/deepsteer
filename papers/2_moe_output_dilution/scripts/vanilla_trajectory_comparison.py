...
3. Write
   ``papers/2_moe_output_dilution/outputs/phase_d/step2_steering/finding2_head_start.json`` with
...
``papers/2_moe_output_dilution/outputs/phase_d/step2_steering/``.
...
Usage
-----
    python papers/2_moe_output_dilution/scripts/vanilla_trajectory_comparison.py

    # Skip retraining (use existing intermediate adapters from this script)
    python papers/2_moe_output_dilution/scripts/vanilla_trajectory_comparison.py --skip-train
...
DEFAULT_OUTPUT_DIR = Path("papers/2_moe_output_dilution/outputs/phase_d/step2_steering")
...
DEFAULT_BASELINE_EVAL = Path("papers/2_moe_output_dilution/outputs/phase_d/c10_v2/eval_baseline.json")
