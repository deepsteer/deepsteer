...
(see `papers/2_moe_output_dilution/scripts/activation_patch_mechanism_check.py`,
...
Haiku 4.5 (`papers/2_moe_output_dilution/scripts/behavioral_judge_rerating.py`,
