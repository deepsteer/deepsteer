...
Usage:
    python papers/moral_geometry/scripts/exp7_framework_fragility.py
    python papers/moral_geometry/scripts/exp7_framework_fragility.py --olmo-only
    python papers/moral_geometry/scripts/exp7_framework_fragility.py --olmoe-only
"""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir",
                        default="papers/moral_geometry/outputs/exp7_fragility")
