...
Usage:
    ...
    python papers/moral_geometry/scripts/exp1_2_3_framework_geometry.py

    # Exp 1+2 only (skip bootstrap, ~15 min)
    python papers/moral_geometry/scripts/exp1_2_3_framework_geometry.py --skip-bootstrap

    # Quick test with reduced dataset
    python papers/moral_geometry/scripts/exp1_2_3_framework_geometry.py --dataset-target 10 --skip-bootstrap

    # Custom bootstrap count
    python papers/moral_geometry/scripts/exp1_2_3_framework_geometry.py --n-bootstrap 100
"""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir",
                        default="papers/moral_geometry/outputs/exp1_2_3")
