...
Usage:
    ...
    python papers/moral_geometry/scripts/exp6_geometric_trajectory.py

    # Subset of checkpoints (fast test)
    python papers/moral_geometry/scripts/exp6_geometric_trajectory.py --max-checkpoints 5

    # Resume from a specific step
    python papers/moral_geometry/scripts/exp6_geometric_trajectory.py --resume-from 18000
"""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir",
                        default="papers/moral_geometry/outputs/exp6_trajectory")
    ...
    figures_dir = Path("papers/moral_geometry/outputs/figures")
