...
Usage:
    python papers/moral_geometry/scripts/exp5_dense_vs_moe_geometry.py
    python papers/moral_geometry/scripts/exp5_dense_vs_moe_geometry.py --quick
"""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir",
                        default="papers/moral_geometry/outputs/exp5_dense_vs_moe")
    ...
    exp1_3_dir = Path("papers/moral_geometry/outputs/exp1_2_3")
