...
The MFV results reveal a property of real-world moral stimuli that laboratory-controlled probing datasets obscure: witnessing moral transgressions of \emph{any} kind preferentially activates the sanctity/degradation representation.
...
Effective foundation-specific steering may require \emph{suppressing} the sanctity component while boosting the target foundation---a two-direction intervention rather than a single injection.
...
\item
  \textbf{Injection at layer 4 produces stronger effects} than layer 12, suggesting that earlier layers are more receptive to direction addition---injected information has more layers to propagate through before reaching the output.
\end{itemize}
