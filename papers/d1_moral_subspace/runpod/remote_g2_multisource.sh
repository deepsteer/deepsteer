...
# Launch via:
#   REMOTE_SCRIPT=papers/d1_moral_subspace/runpod/remote_g2_multisource.sh ./run_session.sh
...
VALIDATE="$VALIDATE" python "$REPO_DIR/papers/d1_moral_subspace/scripts/phase2_g2_multisource.py" \
  --model "$BASE_MODEL"
echo ">> done. Result: papers/d1_moral_subspace/outputs/phase2/g2_multisource_result.json"
