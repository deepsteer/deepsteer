...
Outputs:
    papers/1_accuracy_vs_fragility/figures/figure_1_onset_overlay.png
        (paper-ready)
    papers/1_accuracy_vs_fragility/outputs/phase_c4_compositional/compositional_vs_lexical_onset.png
