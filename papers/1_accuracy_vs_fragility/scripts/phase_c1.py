...
Outputs (in papers/1_accuracy_vs_fragility/outputs/phase_c1/):
...
Usage:
    ...
    python papers/1_accuracy_vs_fragility/scripts/phase_c1.py --dataset-target 10

    # Resume from a specific checkpoint
    python papers/1_accuracy_vs_fragility/scripts/phase_c1.py --resume-from stage1-step18000

    # Run only a subset of probes
    python papers/1_accuracy_vs_fragility/scripts/phase_c1.py --probes layer foundation
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", default="papers/1_accuracy_vs_fragility/outputs/phase_c1",
        help="Directory for output plots and JSON "
             "(default: papers/1_accuracy_vs_fragility/outputs/phase_c1).",
    )
    parser.add_argument(
