...
flagged in `papers/1_accuracy_vs_fragility/outputs/phase_c4_compositional/RESULTS.md`
and locked as a gating decision for
`papers/1_accuracy_vs_fragility/PAPER_PLAN.md` §4.3.
...
read from
`papers/1_accuracy_vs_fragility/outputs/phase_c4_compositional/step_NNNNNNN/c4_step.json`
during aggregation; this script only generates the 3 new seeds.

Decision rule (per `papers/1_accuracy_vs_fragility/PAPER_PLAN.md` §4.3):
...
Outputs (`papers/1_accuracy_vs_fragility/outputs/phase_c4_compositional/3seed/`):
...
Usage:
    ...
    python papers/1_accuracy_vs_fragility/scripts/phase_c4_3seed.py --aggregate-only

    # Resume from a specific step
    python papers/1_accuracy_vs_fragility/scripts/phase_c4_3seed.py --resume-from step18000
"""
