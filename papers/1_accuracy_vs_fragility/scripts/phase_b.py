...
Usage:
    ...
    python papers/1_accuracy_vs_fragility/scripts/phase_b.py

    # Quick test with reduced dataset
    python papers/1_accuracy_vs_fragility/scripts/phase_b.py --dataset-target 10 --trajectory-points 5

    # Run only B1 (single checkpoint, fast)
    python papers/1_accuracy_vs_fragility/scripts/phase_b.py --experiments B1

    # Resume from a specific checkpoint (skip already-completed ones)
    python papers/1_accuracy_vs_fragility/scripts/phase_b.py --resume-from stage1-step200000
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", default="papers/1_accuracy_vs_fragility/outputs/phase_b",
        help="Directory for output plots and JSON "
             "(default: papers/1_accuracy_vs_fragility/outputs/phase_b).",
    )
    parser.add_argument(
