...
-----
  ...
  python papers/1_accuracy_vs_fragility/scripts/phase_c4_compositional.py --validation-only

  # Resume the trajectory from a specific step
  python papers/1_accuracy_vs_fragility/scripts/phase_c4_compositional.py --resume-from step18000

Outputs (``papers/1_accuracy_vs_fragility/outputs/phase_c4_compositional/``):
...
def _load_phase_c2_curves() -> dict[str, tuple[list[int], list[float]]]:
    ...
    Reads ``papers/1_accuracy_vs_fragility/outputs/phase_c2/c2_emergence_timing.json``.
    Returns ``{probe_name: (steps, mean_accuracies)}``.
    """
    c2_path = Path(
        "papers/1_accuracy_vs_fragility/outputs/phase_c2/c2_emergence_timing.json",
    )
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir",
        default="papers/1_accuracy_vs_fragility/outputs/phase_c4_compositional",
