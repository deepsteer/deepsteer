...
| **H3** | **Publish P3** — FL §3 (compositional moral encoding) rests on `reblitzrichardson2026geometry` ("How LMs Organize and Structure Moral Knowledge"), cited once, currently an in-series `note={Paper 3, this series}`. | publication decision | publish P3 (gives a real cite) / fold the two numbers into an FL appendix / leave as in-series pointer |
...
- **H4 — LANDED v1 2026-07-05.** `deepsteer/supplement/` built: 14 distilled artifacts
  ...
  runs. (d) DONE 2026-09-13 — published, DOI 10.5281/zenodo.22731361 (v1), cited in FL App E / MN §9 / README. Build record: — Zenodo is the channel (WRITEUP_PHASE_PLAN W4 item 5):
